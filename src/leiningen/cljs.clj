...
(defn- compile
  ...
  [project]
  (cljsc "src" (str "{:output-to \"" (:name project)
                    ".js\" :optimizations :advanced}")))

(defn- compile-dev
  "Compiles ClojureScript to JavaScript, without optimizations"
  [project]
  (cljsc "src" (str "{:output-dir \"out-dev\" :output-to \"" (:name project)
                    "-dev.js\" :pretty-print true}")))
...
(defn- war
  ...
  (let [project-name (:name project)]
    (exec (str "zip " project-name ".war index.html flurfunk.css "
               project-name ".js"))))
...
(defn- clean
  ...
  [project]
  (let [project-name (:name project)]
    (exec (str "rm -rf " project-name ".war " project-name ".js " project-name
               "-dev.js out out-dev"))))
